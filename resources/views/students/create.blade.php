        ...
        <div class="card-body">
            <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('batch_no') is-invalid @enderror" name="batch_no" value="{{ old('batch_no') }}" required>
                                @error('batch_no')
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="time" class="form-control @error('batch_timings') is-invalid @enderror" name="batch_timings" value="{{ old('batch_timings') }}" required>
                                @error('batch_timings')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control @error('faculty_name') is-invalid @enderror" name="faculty_name" value="{{ old('faculty_name') }}" required>
                                @error('faculty_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card inner-card shadow-sm mb-4">
                    <div class="card-header py-3">
                        <h6 class="mb-0">
                            <i class="fas fa-user-lock me-2"></i>Login Information
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('student_user_id') is-invalid @enderror" name="student_user_id" value="{{ old('student_user_id') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('user_credential') is-invalid @enderror" name="user_credential" value="{{ old('user_credential') }}" placeholder="Optional">
                ...
                <div class="card inner-card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label class="form-label text-muted small">Email ID</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('id_proof_number') is-invalid @enderror" name="id_proof_number" value="{{ old('id_proof_number') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control @error('contact_number') is-invalid @enderror" name="contact_number" value="{{ old('contact_number') }}" pattern="[0-9]{10}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control @error('whatsapp_number') is-invalid @enderror" name="whatsapp_number" value="{{ old('whatsapp_number') }}" pattern="[0-9]{10}" required>
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('course_enrolled') is-invalid @enderror" name="course_enrolled" value="{{ old('course_enrolled') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('college_name') is-invalid @enderror" name="college_name" value="{{ old('college_name') }}" required>
                                @error('college_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('college_address') is-invalid @enderror" name="college_address" rows="3" required>{{ old('college_address') }}</textarea>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_pursuing" value="1" {{ old('is_pursuing') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="looking_for_job" value="1" {{ old('looking_for_job') ? 'checked' : '' }}>
                                    <label class="form-check-label">Yes</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control @error('student_photo') is-invalid @enderror" name="student_photo" accept="image/*" required>
                                @error('student_photo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control @error('student_signature') is-invalid @enderror" name="student_signature" accept="image/*" required>
                ...
                <div class="text-end">
                    ...
                    <a href="{{ route('students.index') }}" class="btn btn-light ms-2">
